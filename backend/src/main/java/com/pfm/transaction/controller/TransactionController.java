...
public class TransactionController {
    ...
    @PostMapping public Transaction create(@RequestBody TransactionRequest req){return service.createTransaction(current.getUserId(),req);}    
    @PutMapping("/{id}") public Transaction update(@PathVariable Long id,@RequestBody TransactionRequest req){return service.updateTransaction(current.getUserId(),id,req);}    
