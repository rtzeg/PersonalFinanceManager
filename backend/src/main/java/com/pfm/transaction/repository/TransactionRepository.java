...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    """)
    BigDecimal sumAmountByTypeInPeriod(Long userId, TransactionType type, LocalDateTime start, LocalDateTime end);
    ...
    @Query("""
        ...
        group by t.category
    """)
    List<Object[]> sumByCategory(Long userId, TransactionType type, LocalDateTime start, LocalDateTime end);
}
