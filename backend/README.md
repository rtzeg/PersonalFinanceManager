...
- Demo пользователь backend (для фронта):
  - username: `demo`
  - password: `demo123`

Фронтенд при отсутствии сессии сначала вызывает `/api/auth/me`, затем автоматически делает register/login demo-пользователя.
